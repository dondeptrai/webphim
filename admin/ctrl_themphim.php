...
<?php
    ...
    $themsp_qr = "INSERT INTO phim (maPhim,maTheloai,Ten,Quoc_Gia,Phan_Loai,Dien_Vien,Nam,Thoi_Luong,Noi_Dung,Ngon_Ngu,hinhanh,trailerlink,linkphim) VALUES ('$id','$maLP','$ten', '$quocgia', '$phanloai','$dienvien','$nam','$thoiluong','$thongtin','$ngonngu','$hinhanh','$trailer','$linkphim')";

    if ($link->query($themsp_qr)){
        echo "<script>alert('Thêm phim thành công'); window.location.href='admin.php?pid=2';</script>";
    } else {
        echo "<script>alert('Thêm không thành công.Kiểm tra lại lỗi!'); window.location.href='admin.php?pid=2'</script>";    
    }
?>
